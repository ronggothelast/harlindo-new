        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                <div className="rounded-[calc(2rem-0.375rem)] bg-bg-card shadow-card-inset h-full p-6 md:p-8 lg:p-9 flex flex-col">
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-fg-secondary">
